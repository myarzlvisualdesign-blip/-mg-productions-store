      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="store-floating-button fixed right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-purple-500 to-purple-700 text-white shadow-lg shadow-purple-500/30 group hover:from-purple-400 hover:to-purple-600 md:bottom-8 md:right-5"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="store-floating-panel fixed right-4 z-50 flex h-[min(70vh,540px)] w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-2xl md:bottom-8 md:right-5 sm:h-[500px] sm:w-96"
            style={{
